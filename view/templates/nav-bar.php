            ...
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="../Examenes/nuevoexamen.php">Nuevo Tipo Examen</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="../usuarios/crearUsuario.php">Nuevo usuario</a></li>
                  <li><a class="dropdown-item" href="../usuarios/mostrarUsuario.php?buscar=&Tipo=">Mostrar usuarios</a></li>
